...
- `name`: TEXT (Nullable)
- `basin_id`: VARCHAR(50) (Foreign Key -> `basins.basin_id`, ON DELETE SET NULL, Nullable)
- `wetland_id`: VARCHAR(50) (Foreign Key -> `wetlands.wetland_id`, ON DELETE SET NULL, Nullable)
- `site_id`: VARCHAR(50) (Foreign Key -> `sites.site_id`, ON DELETE SET NULL, Nullable)
- `geo`: JSONB (Nullable)
