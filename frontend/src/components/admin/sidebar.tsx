...
import { LayoutDashboard, ShieldAlert, Users, MapPin, Database, History } from 'lucide-react';
...
export default function Sidebar({ closeMobileSidebar }: { closeMobileSidebar?: () => void }) {
